...
class Game {
  ...
  endGame(msg) {
    alert(msg);
    document.getElementById('column-top').removeEventListener('click', this.bindClick)
    document.getElementById('ngb').innerHTML = 'reload'
    document.getElementById('ngb').addEventListener('click', (e) => {
